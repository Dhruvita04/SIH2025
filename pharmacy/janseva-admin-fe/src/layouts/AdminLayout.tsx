...
import { Moon, Sun,  LogOut, Menu, FileText, LayoutDashboard, ChevronDown } from 'lucide-react'
...
import { ADMIN_HOME_UI, ADMIN_CATEGORIES_UI, ADMIN_PRODUCTS_UI, ADMIN_ORDERS_UI, ADMIN_USERS_UI, ADMIN_PAYMENTS_UI, ADMIN_COMPANIES_UI, ADMIN_PRESCRIPTIONS_UI, ADMIN_COUPONS_UI, ADMIN_CONTACTS_UI } from '@/utils/ROUTES'
...
export default function AdminLayout() {
    ...
    const menuItems = [
        ...
        { icon: FileText, label: 'contact', value: 'contact', path: ADMIN_CONTACTS_UI },
