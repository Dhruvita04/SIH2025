...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'soft': '0 2px 15px -3px rgba(13, 148, 136, 0.1), 0 10px 20px -2px rgba(13, 148, 136, 0.05)',
        'medium': '0 4px 25px -5px rgba(13, 148, 136, 0.15), 0 10px 10px -5px rgba(13, 148, 136, 0.05)',
        'large': '0 20px 25px -5px rgba(13, 148, 136, 0.15), 0 10px 10px -5px rgba(13, 148, 136, 0.05)',
        'primary': '0 4px 14px 0 rgba(13, 148, 136, 0.2)',
        'secondary': '0 4px 14px 0 rgba(249, 115, 22, 0.2)',
        'accent': '0 4px 14px 0 rgba(168, 85, 247, 0.2)',
      },
      animation: {
